...
export const SelectTool: ToolHandler = {
  onClick: (e, { state }) => {
    ...
    console.log('[SelectTool] resetting selection. Target:', e.target.name(), 'Mode:', state.mode);
    ...
    // We add setSelectedRoomId(null) just in case although setSelectedIds handles it.
