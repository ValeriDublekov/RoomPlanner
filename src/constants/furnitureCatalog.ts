...
export const FURNITURE_CATALOG: CatalogItem[] = [
  ...
  {id: 'wall-cabinet', name: 'Wall Cabinet', furnitureType: 'shelf', category: 'Living Room', type: 'rectangle', width: 100, depth: 30, height3d: 60, defaultElevation: 120, defaultColor: '#f1f5f9', defaultHasDoors: true, svgPath: 'M0 0 H100 V100 H0 Z M50 0 V100 M40 45 H45 M55 45 H60'},
  {id: 'kitchen-unit', name: 'Kitchen Cabinet', furnitureType: 'shelf', category: 'Kitchen', type: 'rectangle', width: 60, depth: 60, height3d: 85, defaultColor: '#f1f5f9', defaultHasDoors: true, svgPath: 'M0 0 H100 V100 H0 Z M50 0 V100 M40 45 H45 M55 45 H60'},
  {id: 'wall-picture', name: 'Wall Picture', furnitureType: 'picture', category: 'Living Room', type: 'rectangle', width: 80, depth: 4, height3d: 60, defaultElevation: 120, defaultColor: '#ffffff', defaultImageUrl: 'https://picsum.photos/seed/minimal-1/400/300', svgPath: 'M10 10 H90 V90 H10 Z M20 20 L40 60 L60 40 L80 70 L20 70 Z'},
  ...
  {id: 'air-conditioner-unit', name: 'Air Conditioner', furnitureType: 'air-conditioner', category: 'Living Room', type: 'rectangle', width: 90, depth: 22, height3d: 30, defaultElevation: 230, defaultColor: '#ffffff', svgPath: 'M0 20 H100 V60 H0 Z M10 60 H90 V65 H10 Z'},
  {id: 'rug-rectangular', name: 'Rectangular Rug', furnitureType: 'rug', category: 'Living Room', type: 'rectangle', width: 200, depth: 150, height3d: 1, defaultElevation: 0, defaultColor: '#f1f5f9', svgPath: 'M5 5 H95 V95 H5 Z M15 15 H85 V85 H15 Z M25 25 H75 V75 H25 Z'},
